...
The basis of this project has been taken from
[Openwhisk-Devtools](https://github.com/apache/openwhisk-devtools).

The files have been modified slightly to make openwhisk work with Camunda.
...
Now update wsk cli properties
```bash
wsk property set --apihost https://localhost -i
wsk property set --auth 789c46b1-71f6-4ed5-8c54-816aa4f8c502:abczO3xZCLrMN6v2BKK1dXYFpXlPkccOFqm12CdAsMgRU4VrNZ9lyGVCGuMDGIwP -i
```

Now add kafka trigger
```base
./installKafka.sh 789c46b1-71f6-4ed5-8c54-816aa4f8c502:abczO3xZCLrMN6v2BKK1dXYFpXlPkccOFqm12CdAsMgRU4VrNZ9lyGVCGuMDGIwP localhost https://whisk_admin:some_passw0rd@localhost:5984 test_ localhost
```

Create test function
```bash
wsk package create test -i
./createAction.sh
# test it
curl https://localhost/api/v1/web/guest/test/helloMy.json?name=Sytse -X GET -H "X-Require-Whisk-Auth: SuperSecret" -k
```
